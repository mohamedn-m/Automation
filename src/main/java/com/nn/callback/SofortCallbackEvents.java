...
public class SofortCallbackEvents implements CallbackEventInterface{

	CallbackProperties callback;

	public SofortCallbackEvents() {
	...
	@Step("Perform ONLINE_TRANSFER event")
	@Override
	public String transactionUpdateStatus(String tid, String status) {
		...
		callback.setPaymentType(ONLINE_TRANSFER);
		return callback.sendCallbackRequest();
	}
