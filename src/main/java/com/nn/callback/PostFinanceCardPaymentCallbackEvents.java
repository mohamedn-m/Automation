...
public class PostFinanceCardPaymentCallbackEvents implements CallbackEventInterface{

	CallbackProperties callback;

	public PostFinanceCardPaymentCallbackEvents() {
	...
	public String transactionCancel(String tid) {
		...
		callback.setPaymentType(POSTFINANCE_CARD);
	...
	public String transactionRefund(String tid) {
		...
		callback.setPaymentType(POSTFINANCE_REFUND);
		return callback.sendCallbackRequest();
	}
	@Step("Perform TRANSACTION_REFUND event")
	@Override
