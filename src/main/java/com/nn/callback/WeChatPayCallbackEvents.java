...
public class WeChatPayCallbackEvents implements CallbackEventInterface{

	CallbackProperties callback;

	public WeChatPayCallbackEvents() {
	...
	public String transactionRefund(String tid) {
		...
		callback.setPaymentType(WECHATPAY_REFUND);
	...
	public String transactionUpdateStatus(String tid, String status) {
		...
		callback.setPaymentType(WECHATPAY);
		return callback.sendCallbackRequest();
	}
