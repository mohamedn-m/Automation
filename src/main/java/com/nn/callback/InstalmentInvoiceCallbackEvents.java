...
public class InstalmentInvoiceCallbackEvents implements CallbackEventInterface{

    CallbackProperties callback;

    public InstalmentInvoiceCallbackEvents(){
    ...
    public String transactionCapture(String tid) {
        ...
        callback.setPaymentType(INSTALMENT_INVOICE);
    ...
    public String transactionRefund(String tid,String amount) {
        ...
        callback.setPaymentType(INSTALMENT_INVOICE_BOOKBACK);
        return callback.sendCallbackRequest();
    }
