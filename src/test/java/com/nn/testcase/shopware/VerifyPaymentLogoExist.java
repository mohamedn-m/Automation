...
public class VerifyPaymentLogoExist extends BaseTest {
    ...
    public void verifyPaymentLogoCashPayment() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Barzahlen/viacash", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoCreditCard() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Credit/Debit Cards", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoDirectDebitSEPA() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Direct Debit SEPA", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoGooglePay() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Google Pay", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoInstalmentInvoice() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Instalment by invoice", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoInstalmentSEPA() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Instalment by SEPA direct debit", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoOnlineBankTransfer() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Online bank transfer", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoPrePayment() {
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Prepayment", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoPostFinance() {
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("PostFinance Card", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoWechatPay() {
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("WeChat Pay", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoBancontact() {
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Bancontact", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoMultibanco() {
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Multibanco", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoPrzelewy24(){
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Przelewy24", true)
                .exitIframe();
    }
    ...
    public void verifyPaymentLogoDirectDebitACH(){
        ...
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Direct Debit ACH", true)
                .exitIframe();
    }
    @Test(priority = 25,description = "Check whether the Blik payment logo displayed as per admin portal configurations ", retryAnalyzer = RetryListener.class)
    public void verifyPaymentLogoBlik(){
        ...
        shopware.getMyAccountPage().changeCurrency("PLN");
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Blik", true)
                .exitIframe();
    }
    @Test(priority = 26, description = "Check whether the Payconiq payment logo displayed as per admin portal configurations ")
    public void verifyPaymentLogoPayconiq() {
        ...
        shopware.getMyAccountPage().changeBillingCountry("Belgium");
        shopware.getCheckoutPage().load().enterIframe()
                .isLogoDisplayed("Payconiq", true)
                .exitIframe();
    }
    @Test(priority = 27, description = "Check whether the Multibanco payment logo displayed as per admin portal configurations ")
