...
public class CreditCardPanHashInsufficientFund extends BaseTest {
    ...
    public void adminLogin(@Optional("cc3") String userName, @Optional("wordpress") String password) {
    ...
    public void insufficientFundCard(){
        navigateCheckout(PRODUCT_1);
        wooCommerce.getCheckoutPage().fillCreditCardForm("4000 0000 0000 1034", "1230", "123");
        wooCommerce.getCheckoutPage().isCreditCardDisplayed();
        wooCommerce.getCheckoutPage().clickPlaceOrderBtn();
        wooCommerce.getCheckoutPage().waitForCreditCardError("Insufficient funds or credit limit exceeded");
    }
