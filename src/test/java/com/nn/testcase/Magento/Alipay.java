...
public class Alipay extends BaseTest {
    ...
    public void setUpCustomer() {
            ...
            updateProductStock(PRODUCT_AlI_PAY);
    ...
    @Test(priority = 1, description = "Check whether the Alipay payment order placed successully and Callback Full refund events executed successfully",retryAnalyzer = RetryListener.class)
    ...
    @Test(priority = 2, description = "Check whether the Alipay payment order placed successully and Callback partial refund events executed successfully executed successfully",retryAnalyzer = RetryListener.class)
    ...
    public void thirdOrder(){
        ...
        navigateCheckout(MagentoAPIs.getCustomerEmail());
        magentoPage.getCheckoutPage().isPaymentMethodDisplayed(ALIPAY);
        magentoPage.getCheckoutPage().waitForAlipayRedirectionPage();
        magentoPage.getNovalnetAdminPortal().openNovalnetAdminPortal();
    ...
    @Test(priority = 4, description = "Check whether the Alipay payment order placed & failed by communication break",retryAnalyzer = RetryListener.class)
    ...
    public void fifthOrder(){
        ...
        navigateCheckout(MagentoAPIs.getCustomerEmail());
        magentoPage.getCheckoutPage().isPaymentMethodDisplayed(ALIPAY);
        magentoPage.getCheckoutPage().cancelAtAlipayRedirectionPage();
   ...
   // @Test(priority = 8,description = "Check whether the payment logo displayed as per admin portal configurations ",retryAnalyzer = RetryListener.class)
    ...
    //@Test(priority = 7, description = "Verify that Alipay payment is hidden on the checkout page when payment is disabled in admin portal")
