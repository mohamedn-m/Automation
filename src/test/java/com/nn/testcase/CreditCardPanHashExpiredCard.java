...
public class CreditCardPanHashExpiredCard extends BaseTest {
    ...
    public void adminLogin(@Optional("cc2") String userName, @Optional("wordpress") String password) {
    ...
    public void expiredCard(){
        ...
        wooCommerce.getCheckoutPage().fillCreditCardForm("4000 0000 0000 0002", "1230", "123");
        wooCommerce.getCheckoutPage().isCreditCardDisplayed();
        wooCommerce.getCheckoutPage().clickPlaceOrderBtn();
        wooCommerce.getCheckoutPage().waitForCreditCardError("Credit card payment not possible: card expired");
    }
