...
public class CreditCardPanHashRestrictedCard extends BaseTest {
    ...
    public void adminLogin(@Optional("cc5") String userName, @Optional("wordpress") String password) {
    ...
    public void restrictedCard(){
        ...
        wooCommerce.getCheckoutPage().fillCreditCardForm("4000 0000 0000 0051", "1230", "123");
        wooCommerce.getCheckoutPage().isCreditCardDisplayed();
        wooCommerce.getCheckoutPage().clickPlaceOrderBtn();
        wooCommerce.getCheckoutPage().waitForCreditCardError("Restricted card");
    }
